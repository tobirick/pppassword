<div class="popup popup--edit-password hidden" data-bind="with: $root.selectedPassword, visibleFade: $root.editPasswordPopupOpen">
    <div class="popup__container">
        <div class="popup__header">
            <h2>Edit password "<span data-bind="text: title"></span>"</h2>
        ...
        <div class="popup__content">
            ...
            <div class="form-row">
                <button class="button button--primary button--block" data-bind="click: $root.updatePassword">Update password</button>
            </div>
        </div>
    </div>
</div>